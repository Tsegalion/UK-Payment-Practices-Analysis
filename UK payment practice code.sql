...
FROM payment_practices
WHERE Start_date >= '2017-01-01'
GROUP BY ROLLUP(YEAR(Filing_date))
...
-- Average days to pay back
SELECT
	Company,
	Company_number,
	CASE WHEN Average_time_to_pay BETWEEN 0 AND 7 THEN '0 - 7days'
	WHEN Average_time_to_pay BETWEEN 8 AND 14 THEN '8 - 14days'
	WHEN Average_time_to_pay BETWEEN 15 AND 21 THEN '15 - 21days'
	WHEN Average_time_to_pay BETWEEN 22 AND 28 THEN '22 - 28days'
	WHEN Average_time_to_pay BETWEEN 29 AND 35 THEN '29 - 35days'
	WHEN Average_time_to_pay BETWEEN 36 AND 42 THEN '36 - 42days'
	WHEN Average_time_to_pay BETWEEN 43 AND 49 THEN '43 - 49days'
	WHEN Average_time_to_pay BETWEEN 50 AND 56 THEN '50 - 56days'
	WHEN Average_time_to_pay BETWEEN 57 AND 63 THEN '57 - 63days'
	WHEN Average_time_to_pay BETWEEN 64 AND 70 THEN '64 - 70days'
	WHEN Average_time_to_pay BETWEEN 71 AND 77 THEN '71 - 77days'
	WHEN Average_time_to_pay >=78 THEN '78+ days'
	WHEN Average_time_to_pay IS NULL THEN 'Null' END AS Day_Range
FROM payment_practices
WHERE Start_date >= '2017-01-01'
...
FROM payment_practices
WHERE Participates_in_payment_codes = 'Yes'
GROUP BY YEAR(Filing_date)) T3
--
...
SELECT
	...
	CASE
		...
		WHEN Payments_made_in_the_reporting_period = 'False' AND Invoices_not_paid_within_agreed_terms BETWEEN 0 AND 100 THEN 0
		...
		END AS Points
FROM payment_practices
WHERE Start_date >= '2017-01-01' OR Start_date IS NULL -- 'NULL' values are businesses that did not enter into any qualifying contracts in the reporting period.
